...
import { Button, H3, Paragrath2 } from "../..";

const StyledAgendeUmaDemonstracao = styled.section`
  display: flex;
...
export function AgendeUmaDemonstracao() {
  return (
    <StyledAgendeUmaDemonstracao>
      <div className="container">
        <div className="textContainer">
          <H3 text="Agende uma demonstração" color="#455CC7" />
          <Paragrath2
            text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dictum urna eleifend tortor pellentesque nibh urna dui."
            color="#757575"
          />
        </div>
